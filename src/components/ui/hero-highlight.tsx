  ...
  return (
    <motion.span
      ...
      style={{
        ...
        backgroundSize: "100% 50%", // 👈 smaller vertical height
        display: "inline",
      }}
      className={cn(
        `relative inline-flex bg-gradient-to-r from-indigo-300 to-purple-300 dark:from-indigo-500 dark:to-purple-500 px-1.5 py-0.5 rounded-sm`,
        className
      )}
    >
      {children}
